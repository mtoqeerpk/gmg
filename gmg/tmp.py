...
class RibbonFrame(wx.Frame):
    ...
    def __init__(self, parent, id=wx.ID_ANY, title="", pos=wx.DefaultPosition,
        ...
        toolbar_panel = RB.RibbonPanel(home, wx.ID_ANY, "Toolbar", wx.NullBitmap, wx.DefaultPosition,
                                       wx.DefaultSize,
                                       agwStyle=RB.RIBBON_PANEL_NO_AUTO_MINIMISE | RB.RIBBON_PANEL_EXT_BUTTON)
        ...
        self._secondary_gallery = self.PopulateColoursPanel(secondary_panel, self._default_secondary,
                                                            ID_SECONDARY_COLOUR)
    ...
    def AddColourToGallery(self, gallery, colour, dc, value=None):
        ...
        if c.IsOk():
            ...
            if abs(foreground.Red() - c.Red()) + abs(foreground.Blue() - c.Blue()) + abs(
                    foreground.Green() - c.Green()) < 64:
